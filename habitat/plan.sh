pkg_name=hab_version_monitor
pkg_origin=gscho
pkg_deps=(core/ruby core/coreutils)
pkg_build_deps=(core/make core/gcc core/git)
pkg_bin_dirs=(bin)
pkg_upstream_url=https://github.com/gscho/hab_version_monitor
pkg_svc_run="hab_version_monitor -c $pkg_svc_config_path/config.yml"

pkg_version() {
  $(pkg_path_for core/ruby)/bin/ruby -I $SRC_PATH/lib -e "require 'hab_version_monitor/version'; puts HabVersionMonitor::VERSION"
}
